...
public class menuManagement : MonoBehaviour
{
    ...
    public Animator animationMenu; // variable para ver si camina el player en el menu
    ...
    void Update()
    {
        ...
        //animationMenu.SetFloat("caminaH", moveX); adelanto para usaar despues con el movimiento
    }
    ...
    private void OnTriggerStay2D(Collider2D collision)// se llama cuando el collider del objeto con el que colisiona permanece en contacto
    {
        ...
        if ((Input.GetKey(KeyCode.H)) && (collision.gameObject.layer == LayerMask.NameToLayer("start"))) // si se presiona la tecla espacio y el objeto con el que colisiona tiene la etiqueta "start"
        {
